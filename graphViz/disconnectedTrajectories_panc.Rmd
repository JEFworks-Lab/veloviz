...
graphViz(observed = curr.scores.cellsub, projected = proj.scores.cellsub,
         k = 20, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = cell.cols.grph, title = "K = 20, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=1.5, y=2.5, legend = levels(clusters), col = col, pch = 16, cex = 0.8)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 20, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o Ngn low EP\nk=20, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=-2.5, y=3, legend = levels(clusters), col = col, pch = 16, cex = 0.8)

set.seed(1)
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 50, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o Ngn low EP\nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=-2, y=-0.5, legend = levels(clusters), col = col, pch = 16, cex = 0.8)
...
legend(x=0.04, y=0.01, legend = levels(clusters), col = col, pch = 16)
...
legend(x=1, y=1.5, legend = levels(clusters), col = col, pch = 16)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 50, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o preendocrine cells\nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=-2.5, y=0, legend = levels(clusters), col = col, pch = 16,cex = 0.8)
...
legend(x=0.04, y=0.04, legend = levels(clusters), col = col, pch = 16)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 50, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o EP high cells\nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=-2.5, y=2.5, legend = levels(clusters), col = col, pch = 16,cex = 0.8)
...
legend(x=0.05, y=0.02, legend = levels(clusters), col = col, pch = 16)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 50, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o EP high or preendocrine cell\nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=1.5, y=2.5, legend = levels(clusters), col = col, pch = 16,cex=0.8)
...
legend(x=0.04, y=0.02, legend = levels(clusters), col = col, pch = 16)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 50, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o alpha cells\nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=1.5, y=-0.5, legend = levels(clusters), col = col, pch = 16,cex = 0.6)
...
emb.pca.sub = pca.sub$u[,1:2]
row.names(emb.pca.sub) = row.names(all.logODS.sub)
plot(emb.pca.sub, col = pca.cols.sub, pch = 16, xlab = "PC1", ylab = "PC2", main = "PCA on subsampled data \nw/o some alpha cells (25%)", xlim = c(-0.05,0.07))
legend(x=0.04, y=0.02, legend = levels(clusters), col = col, pch = 16)
...
graphViz(observed = currSub.currScores, projected = currSub.projScores,
         k = 20, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.2, weighted = FALSE,
         cell.colors = currSub.cols, title = "w/o some alpha cells (25%) \nk=50, t=0.2, unweighted",
         plot = TRUE, return_graph = FALSE)
legend(x=-2.5, y=2.5, legend = levels(clusters), col = col, pch = 16,cex=0.8)
