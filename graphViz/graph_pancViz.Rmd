...
for (k in ks){
  graphViz(observed = curr.scores.cellsub, projected = proj.scores.cellsub,
         k = k, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.25, weighted = FALSE, 
...
for (t in ts){
  graphViz(observed = curr.scores.cellsub, projected = proj.scores.cellsub,
         k = 10, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = t, weighted = FALSE, 
...
hist(conScores_k[,5],col="black",breaks = 150, xlim=c(-0.5,1),ylim=c(0,9),xlab = "Cell Consistency Score",main="K = 50") 
text(x = c(-0.25,-0.25), y = c(8,4), c(paste("Mean:\n",as.character(mean(conScores_k[,5]))),paste("Median:\n",as.character(median(conScores_k[,5])))))
hist(conScores_k[,6],col="cyan",breaks = 150, xlim=c(-0.5,1),ylim=c(0,9),xlab = "Cell Consistency Score",main="K = 100") 
...
hist(conScores_t[,4],col="yellow",breaks = 125, xlim=c(-0.5,1),ylim=c(0,9),xlab = "Cell Consistency Score",main="t = 0.5")
text(x = c(-0.25,-0.25), y = c(8,4), c(paste("Mean:\n",as.character(mean(conScores_t[,4]))),paste("Median:\n",as.character(median(conScores_t[,4])))))
hist(conScores_t[,5],col="black",breaks = 125, xlim=c(-0.5,1),ylim=c(0,9),xlab = "Cell Consistency Score",main="t = 0.7")
text(x = c(-0.25,-0.25), y = c(8,4), c(paste("Mean:\n",as.character(mean(conScores_t[,5]))),paste("Median:\n",as.character(median(conScores_t[,5])))))
hist(conScores_t[,6],col="cyan",breaks = 125, xlim=c(-0.5,1),ylim=c(0,9),xlab = "Cell Consistency Score",main="t = 0.9")
...
fdgCoords = graphViz(observed = curr.scores.cellsub, projected = proj.scores.cellsub,
                     k = 20, distance_metric = "L2", similarity_metric = "cosine", similarity_threshold = 0.25, weighted = FALSE, 
                     cell.colors = cell.cols.grph, title = NA,
