...
Calculate consistency scores for all embeddings  
```{r consistency score comparisons complete}
delta.exp = vel$deltaE

cons.pca = consistency(emb.pca,delta.exp,nNeighbors = 10)
hist(cons.pca,breaks = 500, xlim = c(0,1))
mean(cons.pca)
median(cons.pca)
cons.tsne = consistency(emb.tsne,delta.exp,nNeighbors = 10)
hist(cons.tsne,breaks = 500, xlim = c(0,1))
mean(cons.tsne)
median(cons.tsne)
cons.umap = consistency(emb.umap,delta.exp,nNeighbors = 10)
hist(cons.umap,breaks = 500, xlim = c(0,1))
mean(cons.umap)
median(cons.umap)
cons.diffmap = consistency(emb.diffmap,delta.exp,nNeighbors = 10)
hist(cons.diffmap,breaks = 500, xlim = c(0,1))
mean(cons.diffmap)
median(cons.diffmap)
cons.veloviz = consistency(emb.veloviz,delta.exp[,rownames(emb.veloviz)],nNeighbors = 10)
hist(cons.veloviz,breaks = 500, xlim = c(0,1))
mean(cons.veloviz)
median(cons.veloviz)
...
```{r plotting theme 1.2}

figthemeC1 = theme_bw(base_size = 18) + 
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
figthemeC2 = theme_bw(base_size = 18) + 
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        plot.title = element_text(hjust=0.5, size = 24),
...
#consistency score
cons.pca = consistency(emb.pca,delta.exp,nNeighbors = 10)
cons.pca.plot = data.frame(x = cons.pca)
mn = mean(cons.pca)
md = median(cons.pca)

#make plot
h.pca = ggplot(cons.pca.plot, aes(x = x)) + 
  geom_histogram(bins = 500) +
  xlim(c(-1,1)) + ylim(0,45) +
  geom_text(x = -0.5, y = 40, label = paste0("median:\n",formatC(md,digits = 2)), size = 6) +
  ggtitle('PCA') + xlab("Consistency Score") + ylab("Count") +
  figthemeC2
...
#consistency score
cons.umap = consistency(emb.umap,delta.exp,nNeighbors = 10)
cons.umap.plot = data.frame(x = cons.umap)
mn = mean(cons.umap)
md = median(cons.umap)

#make plot
h.umap = ggplot(cons.umap.plot, aes(x = x)) + 
  geom_histogram(bins = 500) +
  xlim(c(-1,1)) + ylim(0,45) +
  geom_text(x = -0.5, y = 40, label = paste0("median:\n",formatC(md,digits = 2)), size = 6) +
  ggtitle('UMAP') + xlab("Consistency Score") + ylab("Count") +
  figthemeC2
...
#consistency score
cons.tsne = consistency(emb.tsne,delta.exp,nNeighbors = 10)
cons.tsne.plot = data.frame(x = cons.tsne)
mn = mean(cons.tsne)
md = median(cons.tsne)

#make plot
h.tsne = ggplot(cons.tsne.plot, aes(x = x)) + 
  geom_histogram(bins = 500) +
  xlim(c(-1,1)) + ylim(0,45) +
  geom_text(x = -0.5, y = 40, label = paste0("median:\n",formatC(md,digits = 2)), size = 6) +
  ggtitle('t-SNE') + xlab("Consistency Score") + ylab("Count") +
  figthemeC2
...
#consistency score
cons.diff = consistency(emb.diffmap,delta.exp,nNeighbors = 10)
cons.diffmap.plot = data.frame(x = cons.diff)
mn = mean(cons.diff)
md = median(cons.diff)

#make plot
h.diffmap = ggplot(cons.diffmap.plot, aes(x = x)) + 
  geom_histogram(bins = 500) +
  xlim(c(-1,1)) + ylim(0,45) +
  geom_text(x = -0.5, y = 40, label = paste0("median:\n",formatC(md,digits = 2)), size = 6) +
  ggtitle('Diffusion Map') + xlab("Consistency Score") + ylab("Count") +
  figthemeC2


p = h.diffmap + p.diffmap
p
...
#consistency score
cons.veloviz = consistency(emb.veloviz,delta.exp[,row.names(emb.veloviz)],nNeighbors = 10)
cons.veloviz.plot = data.frame(x = cons.veloviz)
mn = mean(cons.veloviz)
md = median(cons.veloviz)

#make plot
h.veloviz = ggplot(cons.veloviz.plot, aes(x = x)) + 
  geom_histogram(bins = 500) +
  xlim(c(-1,1)) + ylim(0,45) +
  geom_text(x = -0.5, y = 40, label = paste0("median:\n",formatC(md,digits = 2)), size = 6) +
  ggtitle('VeloViz') + xlab("Consistency Score") + ylab("Count") +
  figthemeC2


p = h.veloviz + p.veloviz
p
...
layout = c(
  ...
  area(t = 7, l = 4, b = 8, r = 5),

  area(t = 9, l = 1, b = 10, r = 3),
  area(t = 9, l = 4, b = 10, r = 5)
)
...
ggsave(file = "suppfig_consistency_complete.svg", plot = p, width = 12, height = 17)
ggsave(file = "suppfig_consistency_complete.png", plot = p, width = 12, height = 17)
