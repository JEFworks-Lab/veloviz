...
plot(fdg1, col = cell.cols.grph, pch = 16, main = "scvelo velocity graph - unweighted", xlab = "", ylab = "")
set.seed(30)
fdg = layout_with_fr(g, dim = 2)
colnames(fdg) = c("C1","C2")
rownames(fdg) = cell.names.sub
plot(fdg, col = cell.cols.grph, pch = 16, main = "scvelo velocity graph - unweighted", xlab = "", ylab = "")
...
plot(fdg_wts1, col = cell.cols.grph, pch = 16, main = "scvelo velocity graph - weighted", xlab = "", ylab = "")
set.seed(5)
fdg_wts = layout_with_fr(g_wts, dim = 2)
colnames(fdg_wts) = c("C1","C2")
rownames(fdg_wts) = cell.names.sub
plot(fdg_wts, col = cell.cols.grph, pch = 16, main = "scvelo velocity graph - weighted", xlab = "", ylab = "")
```
...
```{r consistency scores, results = "hide", fig.width = 8, fig.height=10}
...
hist(g0_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y, main="Our embedding 1")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g0_scores)),paste("Median:",median(g0_scores))))
hist(g1_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y,main="Our embedding 2")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g1_scores)),paste("Median:",median(g1_scores))))

hist(g2_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y, main="scVelo graph - unweighted 1")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g2_scores)),paste("Median:",median(g2_scores))))
hist(g3_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y, main="scVelo graph - unweighted 2")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g3_scores)),paste("Median:",median(g3_scores))))

hist(g4_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y, main="scVelo graph - weighted 1")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g4_scores)),paste("Median:",median(g4_scores))))
hist(g5_scores,col="red",breaks = 150,xlab = xt, xlim = x, ylim = y,main= "scVelo graph - weighted 2")
text(x = c(0.05,0.05),y = c(7,6),labels = c(paste("Mean:",mean(g5_scores)),paste("Median:",median(g5_scores))))
