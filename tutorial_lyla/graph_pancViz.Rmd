...
plot(scale(emb.umap),col = cell.cols.sub, pch = 16)
```
...
graphViz(curr.scores.cellsub,proj.scores.cellsub,100,"L2","cosine",0.25,cell.cols.grph,title = "K = 100")
```
...
emb.pca.sub.grph = emb.pca[cell.names.sub,]
pcaCon = consistency(emb.pca.sub.grph,deltaExp,20,FALSE)

emb.umap.sub.grph = emb.umap.sub[cell.names.sub,]
umapCon = consistency(emb.umap.sub.grph,deltaExp,20,FALSE)
