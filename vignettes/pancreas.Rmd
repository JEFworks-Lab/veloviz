...
```{r other embeddings, fig.height = 7, fig.width=8, eval=FALSE}
par(mfrow = c(2,2))
...
```{r velocity on other embeddings, fig.height = 9, fig.width=10, eval=FALSE}
par(mfrow = c(2,2))
...
Now let's project velocity inferred from `velocyto.R` onto these embeddings.  
```{r velocity on other embeddings missing, fig.height = 9, fig.width=10, eval=FALSE}
par(mfrow = c(2,2))
